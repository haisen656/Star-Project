...
import { LanBridgeClient, type LocalBridgeFile } from '../lib/lan-bridge';
...
export default function TransferPanel() {
  ...
  const bridgeRef = useRef<LanBridgeClient | null>(null);
  ...
  useEffect(() => {
    ...
    const bridge = new LanBridgeClient(space.id, {
      onIncomingFile: (file) => {
